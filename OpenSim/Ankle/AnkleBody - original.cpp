...
int main()
{
    try {
        ...
        // Weld feet to ground
        Vec3 locationInParent(0, feetSize(1) / 2, 0);
...
*/
        ...
        locationInParent.set(0, 0);
        locationInParent.set(1, 0.8 * h - feetSize(1) - shankSize(1) - thighSize(1) - hatSize(1) * 0.626);
        locationInParent.set(2, 0);
